...
import com.bearchoke.platform.server.BearchokeWebApplicationInitializer;
import com.bearchoke.platform.server.ServerConstants;
import com.bearchoke.platform.server.web.ApplicationMediaType;
import com.bearchoke.platform.server.web.support.client.StompMessageHandler;
import com.bearchoke.platform.server.web.support.client.StompSession;
...
public class IntegrationQuotesWebSocketTest {
	...
	public static void setup() throws Exception {
		...
		server.deployConfig(BearchokeWebApplicationInitializer.class);
		server.start();
