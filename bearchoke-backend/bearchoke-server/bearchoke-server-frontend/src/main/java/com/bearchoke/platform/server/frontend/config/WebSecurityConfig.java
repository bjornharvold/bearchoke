...
import com.bearchoke.platform.server.frontend.security.ApiRequestHeaderAuthenticationFilter;
import com.bearchoke.platform.server.frontend.security.UnauthorizedEntryPoint;
